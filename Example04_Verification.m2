--------------------------------------------------------------------------------
-- Example 4: computational verification
--
-- Curve:
--   f = x_0^14*x_1 + x_0*x_2^14 + x_1^14*x_2 + x_0^5*x_1^5*x_2^5
--
-- This file verifies the computational claims used in Example 4:
--
...
print "============================================================";
print "EXAMPLE 4 COMPUTATIONAL VERIFICATION";
print "============================================================";
...
-- This is the computational statement used in Example 4.
assert(#lowGenDegrees == 0);

print "PASS: M_V has no minimal homogeneous generator of total degree <= d-4.";
print " ";
print "============================================================";
print "ALL COMPUTATIONAL CHECKS FOR EXAMPLE 4 PASSED.";
print "============================================================";
