--------------------------------------------------------------------------------
-- Example 10: computational verification
--
-- Family:
--
--   f = x_0^(2*n) + x_0^n*x_1^n + x_1^(2*n) + x_1*x_2^(2*n-1) + x_2^(2*n),
--   n >= 7.
--
-- IMPORTANT:
...
--       factorized parallel locus stated in Example 10.
--
...
print "============================================================";
print("EXAMPLE 10 VERIFICATION WITH n = " | toString n 
    | ", d = " | toString d);
print "============================================================";
...
expectedComponents = {
    ideal (x_2),
    ideal ((2*n-1)*x_1 + 2*n*x_2),
    ideal (x_1*a_0 - x_0*a_1),
    ideal (x_2*a_1 + ((2*n-1)*x_1 + 2*n*x_2)*a_2)
};
...
print " ";
print "============================================================";
print("ALL COMPUTATIONAL CHECKS FOR EXAMPLE 10 PASSED FOR n = " |
      toString n | ".");
print "============================================================";
