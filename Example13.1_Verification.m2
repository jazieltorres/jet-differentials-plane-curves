--------------------------------------------------------------------------------
-- Example 13, 1st curve: computational verification
--
-- Family:
--
--     f = x_0^d + x_1^d + x_2^d
...
--
--   (1) C = V(f) is smooth.
--   (2) For d >= 7, M_V has exactly one minimal homogeneous generator 
--       of total degree <= d-4.
--   (3) That generator has bidegree (2,1).
...
print "============================================================";
print("EXAMPLE 13, 1st CURVE VERIFICATION WITH d = " | toString d | ".");
print "============================================================";
