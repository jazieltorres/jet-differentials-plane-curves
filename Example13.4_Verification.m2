--------------------------------------------------------------------------------
-- Example 13, 4th curve: computational verification
--
-- Family:
--
--     x_0^d + x_1*(x_0^(d-1) + x_1^(d-1) + x_2^(d-1))
--
...
print "============================================================";
print("EXAMPLE 13, 4th CURVE VERIFICATION WITH d = " | toString d | ".");
print "============================================================";
...
P = QQ[x_0..x_2];
f = x_0^d + x_1*(x_0^(d-1) + x_1^(d-1) + x_2^(d-1));
