--------------------------------------------------------------------------------
-- Example 3: computational verification
--
-- Curve:
--   f = x_0^17 + 2*x_1^17 + 3*x_2^17 + 13*x_0^6*x_1^5*x_2^6
--
-- This file verifies the computational claims used in Example 3:
--
--   (1) C = V(f) in P^2 is smooth.
--
--   (2) The bigraded module M_V defined in Section 5 has no minimal
--       homogeneous generator of total degree <= d-4 = 13.
--
...
print "============================================================";
print "EXAMPLE 3 COMPUTATIONAL VERIFICATION";
print "============================================================";
...
-- This is the computational statement used in Example 3.
assert(#lowGenDegrees == 0);

print "PASS: M_V has no minimal homogeneous generator of total degree <= d-4.";
print " ";
print "============================================================";
print "ALL COMPUTATIONAL CHECKS FOR EXAMPLE 3 PASSED.";
print "============================================================";
