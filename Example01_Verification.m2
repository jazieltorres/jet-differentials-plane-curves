...
--
-- Curve:
--   f = x_0^15 + x_1^15 + x_2^15 + x_0^5*x_1^5*x_2^5
--
-- This file verifies the computational claims used in Example 1:
--
...
print "============================================================";
print "EXAMPLE 1 COMPUTATIONAL VERIFICATION";
print "============================================================";
...
-- This is the computational statement used in Example 1.
assert(#lowGenDegrees == 0);

print "PASS: M_V has no minimal homogeneous generator of total degree <= d-4.";
print " ";
print "============================================================";
print "ALL COMPUTATIONAL CHECKS FOR EXAMPLE 1 PASSED.";
print "============================================================";
