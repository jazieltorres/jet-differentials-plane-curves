--------------------------------------------------------------------------------
-- Example 7: computational verification
--
-- Curve:
--   f = x_0^18 + x_1^18 + x_2^18 + x_0^9*x_1^9 + x_0^12*x_1^4*x_2^2
--
-- This file verifies:
--
...
--       <= d-4 = 14.
--   (3) That generator has bidegree (11,1).
...
print "============================================================";
print "EXAMPLE 7 COMPUTATIONAL VERIFICATION";
print "============================================================";
...
-- This is the computational statement used in Example 7.
assert(#lowGenDegrees == 1);
assert(lowGenDegrees#0 == {11,1});

p = (lowGenDegrees#0)#0;
q = (lowGenDegrees#0)#1;

print "PASS: the unique low-degree minimal generator has bidegree (11,1).";
...
print " ";
print "============================================================";
print "ALL COMPUTATIONAL CHECKS FOR EXAMPLE 7 PASSED.";
print "============================================================";
