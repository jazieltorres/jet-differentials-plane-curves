--------------------------------------------------------------------------------
-- Example 13, 3rd curve: computational verification
--
-- Family:
--
--     f = x_0^d + x_1^d + x_2^d + x_0^(d-1)*x_1
--
-- This file verifies the computational claims in Example 13:
--
--   (1) C = V(f) is smooth.
--   (2) For d >= 8, M_V has exactly one minimal homogeneous generator 
--       of total degree <= d-4.
--   (3) That generator has bidegree (3,1).
...
print "============================================================";
print("EXAMPLE 13, 3rd CURVE VERIFICATION WITH d = " | toString d | ".");
print "============================================================";
